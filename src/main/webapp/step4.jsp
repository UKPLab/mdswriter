...
%><jsp:include page="_header.jsp">
	<jsp:param name="pageTitle" value="step4.title"/>
</jsp:include>
	<script type="text/javascript">
		...
		function revisedTextChanged(source) {
			...
			sendMessage('4REV' + nugget[0] + "\t" + source.value);
		}
...
<jsp:include page="_title.jsp">
	<jsp:param name="pageTitle" value="step4.title"/>
	<jsp:param name="helpFile" value="step4.html"/>
</jsp:include>
			<div id="coreference" class="body nuggetRevision">
				<div class="left">
